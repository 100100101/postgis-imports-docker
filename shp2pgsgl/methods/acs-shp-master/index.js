...
mkdirp('shp', function (err) {
    ...
    if (err) {
        ...
        makerequest(
            'https://s3-us-west-2.amazonaws.com/acs14geo/',
            'carto_bg_14.zip'
        ) //bg CARTO
        makerequest(
            'https://s3-us-west-2.amazonaws.com/acs14geo/',
        ...
        makerequest(
            'http://ftp2.census.gov/geo/tiger/TIGER2014/COUNTY/',
            'tl_2014_us_county.zip'
        ) //county TIGER
        makerequest(
            'http://ftp2.census.gov/geo/tiger/TIGER2014/STATE/',
...
function upload() {
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/cb_2014_us_county_500k.shp carto.county | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/cb_2014_us_state_500k.shp carto.state | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/carto_bg_14.shp carto.bg | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/carto_pl_14.shp carto.place | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/carto_tr_14.shp carto.tract | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/tl_2014_us_county.shp tiger.county | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/tl_2014_us_state.shp tiger.state | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/tiger_bg_14.shp tiger.bg | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/tiger_pl_14.shp tiger.place | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
    ...
    process.stdout.write(
        child_process.execSync(
            "shp2pgsql -W 'latin1' -s 4326 shp/tiger_tr_14.shp tiger.tract | psql -d " +
                obj.db +
                ' -U ' +
                obj.name +
                ' -h ' +
