...
docker run --name ubuntu_bash --rm -it osm2pgsql_ubuntu_osm2pgsql osm2pgsql --create --slim --cache 2000 --database=$PG_CONNECTION_URL ./osm2pgsql/osm/$OSM_PBF_FILENAME
